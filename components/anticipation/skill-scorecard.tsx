      ...
      <div className="relative bg-card border border-border/50 rounded-2xl p-6 shadow-lg backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-text">ID: C-4821</p>
          </div>
        ...
        <div className="flex gap-6 mb-4">
          <div>
            <p className="text-xs text-text mb-1">Total Score</p>
              ...
              {["React", "TypeScript", "Node.js", "PostgreSQL", "AWS"].map(
                (skill) => (
                  <Badge
                    key={skill}
                    variant="secondary"
                    className="text-xs px-2 py-0.5 bg-muted/50 text-text"
                  >
                    {skill}
                  </Badge>
                )
        ...
        {/* Assessment Badges */}
        <div>
          <p className="text-xs text-text mb-2">Assessment Taken</p>
          <div className="flex gap-2">
