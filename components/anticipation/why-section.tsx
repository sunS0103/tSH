        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="pl-8 space-y-6 text-lg md:text-xl text-muted-foreground leading-relaxed">
            ...
            <div className="relative">
              <div className="absolute -top-4 -right-4 text-sm font-medium text-muted-foreground bg-background/80 px-3 py-1 rounded-full border border-border/50 z-10">
