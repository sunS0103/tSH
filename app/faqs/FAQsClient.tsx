...
This gives you a complete picture in a single glance — score + skill area.`
    ...
    {
      icon: PieChart,
      question: "Can I see a detailed score report of how the candidate performed in each skill?",
      answer: `Yes.
...
You'll receive an email alert whenever a candidate matching your filters appears on the platform.`
    ...
    {
      icon: Globe,
      question: "I have a job opening. Can I share the assessment link publicly?",
      answer: `Yes.
...
Their scores will automatically appear in your Talent Pool, where you can review and shortlist them.`
    ...
    {
      icon: Building2,
      question: "I have bulk hiring needs and don't have time to manage this process. Can you help?",
      answer: `Definitely.
...
• Coordinate directly with them for your tasks`
    ...
    {
      icon: UserPlus,
      question: "I'm an employee and see internal openings in my company. Can I refer candidates from here?",
      answer: `Absolutely.
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-slate-900 mb-2">
              {activeTab === 'candidate' ? 'Candidate Questions' : 'Recruiter Questions'}
            </h2>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-emerald-600 text-white font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all"
          >
